...
namespace DAL.SQLight.Migrations
{
    ...
    [Migration("20231214205844_AddDefectToAnImage")]
    partial class AddDefectToAnImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Defects.Defect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int?>("PredictedFromImageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("PredictedFromImageId");
            ...
            modelBuilder.Entity("Domain.Defects.Defect", b =>
                {
                    b.HasOne("Domain.ImageEntity", "PredictedFromImage")
                        .WithMany()
                        .HasForeignKey("PredictedFromImageId");

                    b.Navigation("PredictedFromImage");
                });
